...
MESSAGES["pt-BR"] = {
  ...
  topicHelpIntro2: "Mensagens normais em um topic vinculado sao encaminhadas ao OpenCode.",
  topicHelpIntro3: "Fotos, documentos, audios, notas de voz e videos tambem sao encaminhados.",
  generalHelpIntro1: "Use o chat geral para criar e inspecionar sessoes do OpenCode.",
  generalHelpIntro2: "Comandos no chat geral devem mencionar o bot explicitamente.",
  generalHelpIntro3: "Use forum topics para conversar com uma sessao vinculada especifica.",
  commands: "Comandos:",
  examples: "Exemplos:",
  ...
  helpTopicShare: "/share - gera um link de compartilhamento para a sessao atual",
  ...
  helpTopicLink: "/link <session-id> - vincula este topic a uma sessao existente do OpenCode",
  helpTopicUnlink: "/unlink - remove o mapeamento atual topic/sessao",
  helpTopicHelp: "/help - mostra esta ajuda",
  helpGeneralNewtopic: "{mention} /newtopic <titulo> - cria uma nova sessao do OpenCode e o topic correspondente no Telegram",
  helpGeneralListtopics: "{mention} /listtopics - mostra os mapeamentos salvos de topic/sessao",
  helpGeneralStatus: "{mention} /status - mostra o status da ponte e do runtime OpenCode",
  helpGeneralSessions: "{mention} /sessions [limit] - lista sessoes recentes do OpenCode",
  helpGeneralSession: "{mention} /session <session-id> - inspeciona uma sessao do OpenCode",
  helpGeneralProject: "{mention} /project - mostra o projeto atual do OpenCode",
  helpGeneralProjects: "{mention} /projects [limit] - lista projetos conhecidos do OpenCode",
  helpGeneralProviders: "{mention} /providers - lista providers configurados e padroes",
